...
OutputDir={#OutputDir}
OutputBaseFilename=StripMapEditor_v{#AppVersion}_Setup_x64
Compression=lzma2
...
; TIBCO Rendezvous (x64)
Source: "{#SourceDir}\TIBCO.Rendezvous.dll";        DestDir: "{app}"; Flags: ignoreversion
Source: "{#SourceDir}\TIBCO.Rendezvous.dll.config"; DestDir: "{app}"; Flags: ignoreversion
